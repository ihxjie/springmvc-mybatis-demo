...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath }/assets/js/jquery.min.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath }/assets/js/studentview.js"></script>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive table mt-2" id="dataTable1" role="grid" aria-describedby="dataTable_info">
                            <table class="table dataTable my-0" id="dataTable">
                                <p><strong>被评价的老师id：</strong><span>${feedback.teacherId }</span></p>
                                <p><strong>评价的学生id：</strong><span>${feedback.teacherId }</span></p>
                                <p><strong>本次实训id：</strong><span>${feedback.projectId}</span></p>
                                <p><strong>老师不愿意调停课，从不迟到和早退：</strong><span>${feedback.option1}</span></p>
                                <p><strong>老师讲解清楚明白，易于接受：</strong><span>${feedback.option2}</span></p>
                                <p><strong>上课能联系实际，注重培养运用能力：</strong><span>${feedback.option3}</span></p>
                                <p><strong>老师授课方式灵活多样，生动有趣：</strong><span>${feedback.option4}</span></p>
                                <p><strong>老师批改作业及时、认真：</strong><span>${feedback.option5}</span></p>
                                <p><strong>了解本次实训项目的教学目的：</strong><span>${feedback.option6}</span></p>
                                <p><strong>自己通过本次实训已达学习目的：</strong><span>${feedback.option7}</span></p>
                                <p><strong>通过本次实训，对你的团队合作、人际交往等综合素养：</strong><span>${feedback.option8}</span></p>
                                <p><strong>对本次实训的意见（可选填）：</strong><span>${feedback.forUs}</span></p>
                            </table>
                        </div>
                        <div class="row">
