                                ...
                                <div class="card shadow mb-3">
                                    ...
                                    <div class="card-body">
                                        <form method="post">
                                            ...
                                            <div class="form-group"><button class="btn btn-primary btn-xl" type="submit">更新</button></div>
                                        </form>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row mb-3">
                    <div class="col-lg-8 col-xl-12">
                        <div class="card shadow">
                            <div class="card-header py-3">
                                <p class="text-primary m-0 font-weight-bold">实训表
                                    <a class="btn btn-primary btn-sm d-none d-sm-inline-block" role="button" href="${pageContext.request.contextPath}/excel/${project.projectId}" target="_blank" style="float:right">
                                    <i class="fas fa-download fa-sm text-white-50"></i>&nbsp;导出学生Excel表</a></p>
                            </div>
                            <div class="card-body">
                                ...
                                <div class="table-responsive table mt-2" role="grid" aria-describedby="dataTable_info">
                                    <table class="table dataTable my-0" id="dataTable">
                                        ...
                                        <tbody>
                                        <c:forEach var="info" items="${studentTable}">
                                            <tr>
                                                <c:if test="${info.isStudent == 1}">
                                                    <td>学生</td>
                                                </c:if>
                                                <c:if test="${info.isStudent == 0}">
                                                    <td>老师</td>
                                                </c:if>
                                                <td>${info.personId}</td>
