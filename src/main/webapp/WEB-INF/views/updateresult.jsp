...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath }/assets/js/updateteacher.js"></script>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="card shadow mb-3">
                                    ...
                                    <div class="card-body">
                                        <form id="testsForm" name="testsForm" method="post" action="${pageContext.request.contextPath }/sys/resultList/modifysave.html">
                                            <input type = "hidden" id = "path" name = "path" value = "${pageContext.request.contextPath }">

                                                <div class="form-row">
                                                    <div class="col">
                                                        <div class="form-group"><label for="resultId"><strong>成绩id</strong></label><input class="form-control" type="text" name="resultId" id="resultId" value="${result.resultId }"></div>
                                                    </div>
                                                    <div class="col">
                                                        <div class="form-group"><label for="studentId"><strong>学生账号</strong></label><input class="form-control" type="text" name="studentId" id="studentId" value="${result.studentId}"></div>
                                                    </div>
                                                </div>
                                                <div class="form-row">
                                                    <div class="col">
                                                        <div class="form-group"><label for="projectId"><strong>项目id</strong></label><input class="form-control" type="text" name="projectId" id="projectId" value="${result.projectId}"></div>
                                                    </div>
                                                    <div class="col">
                                                        <div class="form-group"><label for="studentName"><strong>学生姓名</strong></label><input class="form-control" type="text" name="studentName" id="studentName" value="${result.studentName}"></div>
                                                    </div>
                                                </div>
                                                <div class="form-row">
                                                    <div class="col">
                                                        <div class="form-group"><label for="result"><strong>成绩</strong></label><input class="form-control" type="text" name="result" id="result" value="${result.result}"></div>
                                                    </div>
                                                </div>
