...
<head>
    ...
    <script type="text/javascript">
        function d(){
            window.location.href="${pageContext.request.contextPath}/sys/resultControllerrr/excel";
        }
    </script>
</head>
                ...
                <table class="providerTable" cellpadding="0" cellspacing="0">
                    ...
                    <c:forEach var="result" items="${resultList}" varStatus="status">
                        ...
                        <tr>
                            ...
                            <td>
                                <span><a class="viewResult" href="javascript:;" resultId=${result.resultId } >查看学生成绩</a></span>
                ...
                <div class="col-md-6 offset-md-4">
                    <nav aria-label="Page navigation example">
                        <ul class="pagination pagination-sm">
                            <li class="page-item"><a class="page-link" href="${BASE_PATH}/springmvc_mybatis_demo_war_exploded//sys/applylist/list{projectId}?page=1">首页</a></li>
                            <c:if test="${pageInfo.hasPreviousPage}">
                                <li class="page-item"><a class="page-link"
                                                         href="${BASE_PATH}/springmvc_mybatis_demo_war_exploded//sys/applylist/list{projectId}?page=${pageInfo.pageNum-1}">上一页</a></li>
                            </c:if>
                            <c:forEach items="${pageInfo.navigatepageNums}" var="page">
                                ...
                                <c:if test="${page!=pageInfo.pageNum}">
                                    <li class="page-item"><a class="page-link"
                                                             href="${BASE_PATH}/springmvc_mybatis_demo_war_exploded//sys/applylist/list{projectId}?page=${page}">${page}</a></li>
                                </c:if>
                            </c:forEach>
                            <c:if test="${pageInfo.hasNextPage}">
                                <li class="page-item"><a class="page-link"
                                                         href="${BASE_PATH}/springmvc_mybatis_demo_war_exploded//sys/applylist/list{projectId}?page=${pageInfo.pageNum+1}">下一页</a></li>
                            </c:if>
                            <li class="page-item"><a class="page-link" href="${BASE_PATH}/springmvc_mybatis_demo_war_exploded//sys/applylist/list{projectId}?page=${pageInfo.pages}">末页</a>
                            </li>
                        </ul>
                    </nav>
                </div>
