...
<div id="wrapper">
    ...
    <div class="d-flex flex-column" id="content-wrapper">
        <div id="content">
            ...
            <span style="float: right"><a href="${pageContext.request.contextPath}/sys/projectlist/add" >申报实训项目</a></span>
            <div class="table-responsive table mt-2" id="dataTable1" role="grid" aria-describedby="dataTable_info">
                <table class="table dataTable my-0" id="dataTable">
                    ...
                    <c:forEach var="project" items="${pageInfo.list}" varStatus="status">
                        ...
                        <tr>
                            ...
                            <td>
                                <span>
                                    <c:if test="${project.isCompany==0}">学校</c:if>
                                    <c:if test="${project.isCompany==1}">公司</c:if>
                                </span>
                            </td>
                            <td>
                                <span>${project.workId}</span>
                            </td>
                            <td>
                            ...
                            <td>
                                <span><a class="viewProject" href="javascript:;" projectId=${project.projectId} ><img src="${pageContext.request.contextPath }/assets/img/read.png" alt="查看" title="查看"/></a></span>
                            </td>
                            <td>
                                <span>
                                    ...
                                    <a class="applyadd"  projectId=${project.projectId }  projectTitle=${project.projectTitle } >报名</a>
                                </c:if>
                                </span>
                            </td>
                        </tr>
                ...
                <div class="col-md-6 offset-md-4">
                    <nav aria-label="Page navigation example">
                        <ul class="pagination pagination-sm">
                            <li class="page-item"><a class="page-link" href="${BASE_PATH}/springmvc_mybatis_demo_war_exploded/projectlist?page=1">首页</a></li>
                            <c:if test="${pageInfo.hasPreviousPage}">
                                <li class="page-item"><a class="page-link"
                                                         href="${BASE_PATH}/springmvc_mybatis_demo_war_exploded/projectlist?page=${pageInfo.pageNum-1}">上一页</a></li>
                            </c:if>
                            <c:forEach items="${pageInfo.navigatepageNums}" var="page">
                                ...
                                <c:if test="${page!=pageInfo.pageNum}">
                                    <li class="page-item"><a class="page-link"
                                                             href="${BASE_PATH}/springmvc_mybatis_demo_war_exploded/projectlist?page=${page}">${page}</a></li>
                                </c:if>
                            </c:forEach>
                            <c:if test="${pageInfo.hasNextPage}">
                                <li class="page-item"><a class="page-link"
                                                         href="${BASE_PATH}/springmvc_mybatis_demo_war_exploded/projectlist?page=${pageInfo.pageNum+1}">下一页</a></li>
                            </c:if>
                            <li class="page-item"><a class="page-link" href="${BASE_PATH}/springmvc_mybatis_demo_wa_explodedr/projectlist?page=${pageInfo.pages}">末页</a>
                            </li>
                        </ul>
                    </nav>
                </div>
