...
<head>
    ...
    <script type="text/javascript">
        function d(){
            window.location.href="${pageContext.request.contextPath}/sys/apply/Controller/excel";
        }
    </script>
</head>
                ...
                <table class="table dataTable my-0" id="dataTable">
                    ...
                    <c:forEach var="apply" items="${applyList}" varStatus="status">
                        <tr>
                            ...
                            <td>
                                <span>${apply.projectId}</span>
                            </td>
                            <td>
                                <span>${apply.personId}</span>
                            </td>
                            <td>
                                <span>${apply.personName}</span>
                            </td>
                            <td>
