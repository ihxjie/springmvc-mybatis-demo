                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive table mt-2" id="dataTable1" role="grid" aria-describedby="dataTable_info">
                            <table class="table dataTable my-0" id="dataTable">
                                <p><strong>姓名id：</strong><span>${student.studentId }</span></p>
                                <p><strong>密码：</strong><span>${student.studentPwd }</span></p>
                                <p><strong>姓名：</strong><span>${student.studentName }</span></p>
                                <p><strong>性别：</strong><span>${student.studentSex}</span></p>
                                <p><strong>专业：</strong><span>${student.studentMajor }</span></p>
                                <p><strong>班级：</strong><span>${student.studentClass }</span></p>
                                <p><strong>联系电话：</strong><span>${student.studentTel }</span></p>
                                <p><strong>个人邮箱：</strong><span>${student.studentEmail }</span></p>
                            </table>
                        </div>
                        <div class="row">
