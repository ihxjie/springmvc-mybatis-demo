                        ...
                        <div class="row">
                            <div class="col">
                                <div class="card shadow mb-3">
                                    ...
                                    <div class="card-body">
                                        <form id="testsForm" name="testsForm" method="post" action="${pageContext.request.contextPath }/sys/applyList/modifysave.html">
                                            <input type = "hidden" id = "path" name = "path" value = "${pageContext.request.contextPath }">


                                            <div class="form-row">
                                                <div class="col">
                                                    <div class="form-group"><label for="applyId"><strong>报名id</strong></label><input class="form-control" type="text" name="applyId" id="applyId" value="${apply.applyId }"></div>
                                                </div>
                                                <div class="col">
                                                    <div class="form-group"><label for="projectId"><strong>项目id</strong></label><input class="form-control" type="password" name="projectId" id="projectId" value="${apply.projectId}"></div>
                                                </div>
                                            </div>
                                            <div class="form-row">
                                                <div class="col">
                                                    <div class="form-group"><label for="personId"><strong>报名账号</strong></label><input class="form-control" type="text" name="personId" id="personId" value="${apply.personId }"></div>
                                                </div>
                                                <div class="col">
                                                    <div class="form-group"><label for="personName"><strong>报名人</strong></label><input class="form-control" type="text" name="personName" id="personName" value="${apply.personName }"></div>
                                                </div>
                                            </div>
                                            <div class="form-row">
                                                <div class="col">
                                                    <div class="form-group"><label for="isStudent"><strong>报名类别</strong></label><input class="form-control" type="text" name="isStudent" id="isStudent" value="${apply.isStudent}"></div>
                                                </div>
