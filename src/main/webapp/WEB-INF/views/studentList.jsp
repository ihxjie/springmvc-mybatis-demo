...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath }/assets/js/deleteStudents.js"></script>
            ...
            <nav class="navbar navbar-light navbar-expand bg-white shadow mb-4 topbar static-top">
                <div class="container-fluid"><button class="btn btn-link d-md-none rounded-circle mr-3" id="sidebarToggleTop" type="button"><i class="fas fa-bars"></i></button>
                        ...
                        <div class="input-group">
                            <form method="post" action="${pageContext.request.contextPath }/sys/studentList/looklist.html">
                                <span>学生账号：</span>
                                <input name="studentId" id="studentId" class="input-text"	type="text" value="${studentId}">
            ...
            <div class="container-fluid">
                ...
                <div class="card shadow">
                    <div class="card-header py-3">
                        ...
                        <a href="${pageContext.request.contextPath}/sys/studentList/add.html" >添加学生</a>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 text-nowrap">
                                <button><a name="delAllStudent" id = "delAllStudent" href="#" >批量删除</a></button>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="table-responsive table mt-2" id="dataTable1" role="grid" aria-describedby="dataTable_info">
                            <table class="table dataTable my-0" id="dataTable">
                                ...
                                <c:forEach var="tests" items="${pageInfo.list}" >
                                    <tr>
                                        <td>
                                            <input type="checkbox" name = "cbox" id = "cbox">
                                            <span class = "id">${tests.studentId}</span>
                                        </td>

                                        <td>
                                            <span>${tests.studentName}</span>
                                        </td>
                                        <td>
                                            <span>${tests.studentSex}</span>
                                        </td>
                                        <td>
                                            <span>${tests.studentMajor}</span>
                                        </td>
                                        <td>
                                            <span>${tests.studentClass}</span>
                                        </td>
                                        <td>

                                            <span>${tests.studentTel}</span>
                                        </td>
                                        <td>
                                            <span>${tests.studentEmail}</span>
                                        </td>
                                        <td>
                                            <span><a class="viewStudent" href="javascript:;" studentId=${tests.studentId} studentName=${tests.studentName }><img src="${pageContext.request.contextPath }/assets/img/read.png" alt="查看" title="查看"/></a></span>

                                            <span><a class="modifyStudent"  href="javascript:;" studentId=${tests.studentId } studentName=${tests.studentName}><img src="${pageContext.request.contextPath }/assets/img/xiugai.png" alt="修改" title="修改"/></a></span>
                                            <span><a class="deleteStudent" href="javascript:;" studentId=${tests.studentId } studentName=${tests.studentName }><img src="${pageContext.request.contextPath }/assets/img/schu.png" alt="删除" title="删除"/></a></span>
                                        </td>
                                    </tr>
                                </c:forEach>
                            </table>
                            ...
                            <div class="col-md-6 offset-md-4">
                                <nav aria-label="Page navigation example">
                                    <ul class="pagination pagination-sm">
                                        <li class="page-item"><a class="page-link" href="${BASE_PATH}/springmvc_mybatis_demo_war/studentList?page=1">首页</a></li>
                                        <c:if test="${pageInfo.hasPreviousPage}">
                                            <li class="page-item"><a class="page-link"
                                                                     href="${BASE_PATH}/springmvc_mybatis_demo_war/studentList?page=${pageInfo.pageNum-1}">上一页</a></li>
                                        </c:if>
                                        <c:forEach items="${pageInfo.navigatepageNums}" var="page">
                                            ...
                                            <c:if test="${page!=pageInfo.pageNum}">
                                                <li class="page-item"><a class="page-link"
                                                                         href="${BASE_PATH}/springmvc_mybatis_demo_war/studentList?page=${page}">${page}</a></li>
                                            </c:if>
                                        </c:forEach>
                                        <c:if test="${pageInfo.hasNextPage}">
                                            <li class="page-item"><a class="page-link"
                                                                     href="${BASE_PATH}/springmvc_mybatis_demo_war/studentList?page=${pageInfo.pageNum+1}">下一页</a></li>
                                        </c:if>
                                        <li class="page-item"><a class="page-link" href="${BASE_PATH}/springmvc_mybatis_demo_war/studentList?page=${pageInfo.pages}">末页</a>
                                        </li>
                                    </ul>
                                </nav>
                            </div>
