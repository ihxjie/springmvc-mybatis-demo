...
<div class="banner-top">
    <div class="container">
        <h1>商品</h1>
        <em></em>
        <h2><a href="index.html">主页</a><label>/</label>商品</a></h2>
    </div>
</div>
<!--content-->
<div class="product">
                ...
                <div class="col-md-4 item-grid1 simpleCart_shelfItem">
                    <div class=" mid-pop">
                        ...
                        <div class="mid-1">
                            ...
                            <div class="mid-2">
                                <p ><label>￥${product.productOriginalPrice}</label><em class="item_price">￥${product.productCurrentPrice}</em></p>
                                <div class="block">
                ...
                <nav aria-label="Page navigation">
                    <ul class="pagination">
                        ...
                        <li>
                            ...
                            <a href="product/list?pageNo=${pageInfo.pageNum-1}" aria-label="Previous">
                        ...
                        <c:forEach begin="1" end="${pageInfo.pages}" var="i">
                            <c:if test="${pageInfo.pageNum == i}">
                                <li class="active"> <a href="product/list?pageNo=${i}">${i}</a> </li>
                            </c:if>

                            <c:if test="${pageInfo.pageNum != i}">
                                <li> <a href="product/list?pageNo=${i}">${i}</a> </li>
                            </c:if>
                        </c:forEach>
                        ...
                        <li>
                            ...
                            <a href="product/list?pageNo=${pageInfo.pageNum+1}" aria-label="Next">
