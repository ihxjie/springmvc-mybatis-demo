...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath }/assets/js/resultadd.js"></script>
    ...
    <div class="d-flex flex-column" id="content-wrapper">
        <div id="content">
            ...
            <div class="container-fluid">
                <h3 class="text-dark mb-4">添加成绩</h3>
                <div class="row mb-3">
                            ...
                            <div class="col">
                                <div class="card shadow mb-3">
                                    <div class="card-header py-3">
                                        <p class="text-primary m-0 font-weight-bold">添加成绩</p>
                                    </div>
                                    <div class="card-body">
                                        <form id="resultForm" name="resultForm" method="post" action="${pageContext.request.contextPath }/sys/resultlist/addsave.html">
                                            <input type = "hidden" id = "path" name = "path" value = "${pageContext.request.contextPath }">
                                            <form>
                                                <div class="form-row">
                                                    <div class="col">
                                                        <div class="form-group"><label for="projectId"><strong>项目ID</strong></label><input class="form-control" type="text" name="projectId" id="projectId" value="${projectId }"></div>
                                                    </div>
                                                    <div class="col">
                                                        <div class="form-group"><label for="studentId"><strong>学生ID</strong></label><input class="form-control" type="text" name="studentId" id="studentId" value="${studentId}"></div>
                                                    </div>
                                                </div>
                                                <div class="form-row">
                                                    <div class="col">
                                                        <div class="form-group"><label for="studentName"><strong>学生姓名</strong></label><input class="form-control" type="text" name="studentName" id="studentName" value="${studentName }"></div>
                                                    </div>
                                                    <div class="col">
                                                        <div class="form-group"><label for="result"><strong>成绩</strong></label><input class="form-control" type="text" name="result" id="result" value="${result }"></div>
                                                    </div>
                                                </div>
