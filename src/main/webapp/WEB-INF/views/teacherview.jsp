...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath }/assets/js/teacherview.js"></script>
</head>
                            ...
                            <div class="col">
                                <div class="card shadow mb-3">
                                    <div class="card-header py-3">
                                        <p class="text-primary m-0 font-weight-bold">个人详细信息</p>
                                    </div>
                                    <div class="card-body">

                                        <div class="table-responsive table mt-2" id="dataTable1" role="grid" aria-describedby="dataTable_info">
                                            <table class="table dataTable my-0" id="dataTable">
                                                <p><strong>教师ID：</strong><span>${teacherId}</span></p>
                                                <p><strong>姓名：</strong><span>${teacherName }</span></p>
                                                <p><strong>性别：</strong><span>${teacherSex }</span></p>
                                                <p><strong>简介：</strong><span>${introduction}</span></p>
                                                <p><strong>联系电话：</strong><span>${teacherTel }</span></p>
                                                <p><strong>个人邮箱：</strong><span>${teacherEmail }</span></p>
                                            </table>
                                        </div>
                                    </div>
                                </div>
