                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive table mt-2" id="dataTable1" role="grid" aria-describedby="dataTable_info">
                            <table class="table dataTable my-0" id="dataTable">
                                <p><strong>姓名id：</strong><span>${teacher.teacherId }</span></p>
                                <p><strong>姓名：</strong><span>${teacher.teacherName }</span></p>
                                <p><strong>性别：</strong><span>${teacher.teacherSex}</span></p>
                                <p><strong>联系电话：</strong><span>${teacher.teacherTel }</span></p>
                                <p><strong>介绍：</strong><span>${teacher.introduction }</span></p>
                                <p><strong>个人邮箱：</strong><span>${teacher.teacherEmail }</span></p>
                            </table>
                        </div>
                        <div class="row">
