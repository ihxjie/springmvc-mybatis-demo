...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath }/assets/js/feedbackList.js"></script>
    <script type="text/javascript">
        function d(){
            window.location.href="${pageContext.request.contextPath}/sys/feedbackController/excel";
        }
    </script>
            ...
            <nav class="navbar navbar-light navbar-expand bg-white shadow mb-4 topbar static-top">
                <div class="container-fluid"><button class="btn btn-link d-md-none rounded-circle mr-3" id="sidebarToggleTop" type="button"><i class="fas fa-bars"></i></button>
                    <div class="input-group">
                        <form method="post" action="${pageContext.request.contextPath }/sys/feedbackList/looklist.html">
                            <span>反馈id：</span>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive table mt-2" id="dataTable1" role="grid" aria-describedby="dataTable_info">
                            <table class="table dataTable my-0" id="dataTable">
                                ...
                                <thead>
                                <tr>
                                    <th width="10%">被评价的老师id</th>
                                    <th width="10%">评价的学生</th>
                                    <th width="10%">本次实训id</th>
                                    <th width="10%">操作</th>
                                </tr>
                                </thead>
                                ...
                                <c:forEach var="tests" items="${pageInfo.list}" varStatus="status">
                                    <tr>
                                        ...
                                        <td>
                                            <span><a class="viewFeedback" href="javascript:;" teacherId=${tests.teacherId} ><img src="${pageContext.request.contextPath }/assets/img/read.png" alt="查看" title="查看详情"/></a></span>
                                        </td>
                                    </tr>
                                </c:forEach>
                            </table>
