        ...
        <div class="container-fluid d-flex flex-column p-0">
            ...
            <ul class="nav navbar-nav text-light" id="accordionSidebar">
                <li class="nav-item" role="presentation">
                    <a class="nav-link" href="${pageContext.request.contextPath}/company">
                ...
                <li class="nav-item" role="presentation">
                    <div><a class="btn btn-link nav-link" data-toggle="collapse" aria-expanded="false" aria-controls="collapse-1" href="#collapse-1" role="button"><i class="far fa-list-alt"></i>&nbsp;<span>查看已申报的实训项目</span></a>
    ...
    <div class="d-flex flex-column" id="content-wrapper">
        <div id="content">
                        ...
                        <li class="nav-item dropdown no-arrow" role="presentation">
                            <div class="nav-item dropdown no-arrow">
                                ...
                                <div class="dropdown-menu shadow dropdown-menu-right animated--grow-in" role="menu">
                                    <a class="dropdown-item" role="presentation" href="${pageContext.request.contextPath}/logout"><i class="fas fa-sign-out-alt fa-sm fa-fw mr-2 text-gray-400"></i>&nbsp;退出登录</a></div>
                            </div>
                        </li>
                    </ul>
                </div>
            ...
            <div class="container-fluid">
                <h3 class="text-dark mb-4">发布实训</h3>
                <div class="row mb-3">
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="card shadow mb-3">
                                    ...
                                    <div class="card-body">
                                        <form method="post" action="${pageContext.request.contextPath}/add_new_project">
                                            <div class="form-row">
                                                <div class="col">
                                                    <div class="form-group"><label for="projectTitle"><strong>实训标题</strong><br></label>
                                                        <input id="projectTitle" class="form-control" type="text" placeholder="project.title" name="projectTitle"></div>
                                                </div>
                                                <div class="col">
                                                    <div class="form-group"><label for="period"><strong>实训周期</strong><br></label>
                                                        <input id="period" class="form-control" type="text" placeholder="period" name="period"></div>
                                                </div>
                                            </div>
                                            <div class="form-row">
                                                <div class="col">
                                                    <div class="form-group"><label for="projectAddress"><strong>实训地址/基地</strong><br></label>
                                                        <input id="projectAddress" class="form-control" type="text" placeholder="project.address" name="projectAddress"></div>
                                                </div>
                                                <div class="col">
                                                    <div class="form-group"><label for="projectPrice"><strong>实训价格</strong><br></label>
                                                        <input id="projectPrice" class="form-control" type="text" placeholder="project.price" name="projectPrice"></div>
                                                </div>
                                            </div>
                                            <div class="form-row">
                                                <div class="col-md-6 col-xl-12 offset-xl-0">
                                                    <div class="form-group"><label for="projectContent"><strong>实训内容</strong><br></label>
                                                        <textarea id="projectContent" class="form-control" rows="6" name="projectContent"></textarea></div>
                                                </div>
                                            </div>
                                            <div class="form-group"><button class="btn btn-primary btn-sm" type="submit">提交实训</button></div>
                                        </form>
                                    </div>
                                </div>
                            </div>
