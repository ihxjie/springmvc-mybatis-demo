                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive table mt-2" id="dataTable1" role="grid" aria-describedby="dataTable_info">
                            <table class="table dataTable my-0" id="dataTable">
                                <p><strong>成绩id：</strong><span>${result.resultId }</span></p>
                                <p><strong>学生账号：</strong><span>${result.studentId}</span></p>
                                <p><strong>项目id：</strong><span>${result.projectId}</span></p>
                                <p><strong>学生姓名：</strong><span>${result.studentName}</span></p>
                                <p><strong>成绩：</strong><span>${result.result}</span></p>
