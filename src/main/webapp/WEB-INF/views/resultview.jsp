...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath }/assets/js/resultview.js"></script>
</head>
                            ...
                            <div class="col">
                                <div class="card shadow mb-3">
                                    <div class="card-header py-3">
                                        <p class="text-primary m-0 font-weight-bold">查看学生成绩信息</p>
                                    </div>
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive table mt-2" id="dataTable1" role="grid" aria-describedby="dataTable_info">
                                            <table class="table dataTable my-0" id="dataTable">
                                                <
                                                <p><strong>项目ID ：</strong><span>${resultList.projectId}</span></p>
                                                <p><strong>学生ID：</strong><span>${resultList.studentId}</span></p>
                                                <p><strong>学生姓名：</strong><span>${resultList.studentName}</span></p>
                                                <p><strong>学生成绩：</strong><span>${resultList.result}</span></p>
                                            </table>
