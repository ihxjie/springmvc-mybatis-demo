...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath }/assets/js/projectresult.js"></script>
</head>
                ...
                <table class="table dataTable my-0" id="dataTable">
                    ...
                    <c:forEach var="project" items="${pageInfo.list}" varStatus="status">
                        ...
                        <tr>
                            ...
                            <td>
                                <span><a class="addResult" href="javascript:;" projectId=${project.projectId } >给学生打分</a></span>
                                <span><a class="viewProject" href="javascript:;" projectId=${project.projectId}>查看学生成绩</a></span>
                            </td>
                ...
                <div class="col-md-6 offset-md-4">
                    <nav aria-label="Page navigation example">
                        <ul class="pagination pagination-sm">
                            <li class="page-item"><a class="page-link" href="${BASE_PATH}/springmvc_mybatis_demo_war_exploded/sys/resultlist/pass.html?page=1">首页</a></li>
                            <c:if test="${pageInfo.hasPreviousPage}">
                                <li class="page-item"><a class="page-link"
                                                         href="${BASE_PATH}/springmvc_mybatis_demo_war_exploded/sys/resultlist/pass.html?page=${pageInfo.pageNum-1}">上一页</a></li>
                            </c:if>
                            <c:forEach items="${pageInfo.navigatepageNums}" var="page">
                                ...
                                <c:if test="${page!=pageInfo.pageNum}">
                                    <li class="page-item"><a class="page-link"
                                                             href="${BASE_PATH}/springmvc_mybatis_demo_war_exploded/sys/resultlist/pass.html?page=${page}">${page}</a></li>
                                </c:if>
                            </c:forEach>
                            <c:if test="${pageInfo.hasNextPage}">
                                <li class="page-item"><a class="page-link"
                                                         href="${BASE_PATH}/springmvc_mybatis_demo_war_exploded/sys/resultlist/pass.html?page=${pageInfo.pageNum+1}">下一页</a></li>
                            </c:if>
                            <li class="page-item"><a class="page-link" href="${BASE_PATH}/springmvc_mybatis_demo_wa_explodedr/sys/resultlist/pass.html?page=${pageInfo.pages}">末页</a>
                            </li>
                        </ul>
                    </nav>
                </div>
