                        ...
                        <div class="row">
                            <div class="col">
                                <div class="card shadow mb-3">
                                    ...
                                    <div class="card-body">
                                        <form id="testsForm" name="testsForm" method="post" action="${pageContext.request.contextPath }/sys/projectList/modifysave.html">
                                            <input type = "hidden" id = "path" name = "path" value = "${pageContext.request.contextPath }">
                                            <form>

                                                <div class="form-row">
                                                    <div class="col">
                                                        <div class="form-group"><label for="projectId"><strong>项目id</strong></label><input class="form-control" type="text" name="projectId" id="projectId" value="${project.projectId }"></div>
                                                    </div>
                                                    <div class="col">
                                                        <div class="form-group"><label for="workId"><strong>负责方id</strong></label><input class="form-control" type="text" name="workId" id="workId" value="${project.workId }"></div>
                                                    </div>
                                                </div>
                                                <div class="form-row">

                                                    <div class="col">
                                                        <div class="form-group"><label for="period"><strong>项目周期</strong></label><input class="form-control" type="text" name="period" id="period" value="${project.period}"></div>
                                                    </div>
                                                    <div class="col">
                                                        <div class="form-group"><label for="projectTitle"><strong>项目名称</strong></label><input class="form-control" type="text" name="projectTitle" id="projectTitle" value="${project.projectTitle }"></div>
                                                    </div>
                                                </div>
                                                <div class="form-row">

                                                    <div class="col">
                                                        <div class="form-group"><label for="projectContent"><strong>项目内容</strong></label><input class="form-control" type="text" name="projectContent" id="projectContent" value="${project.projectContent}"></div>
                                                    </div>
                                                    <div class="col">
                                                        <div class="form-group"><label for="projectAddress"><strong>项目地址</strong></label><input class="form-control" type="text" name="projectAddress" id="projectAddress" value="${project.projectAddress}"></div>
                                                    </div>
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="col">
                                                        <div class="form-group"><label for="projectPrice"><strong>报名费用</strong></label><input class="form-control" type="text" name="projectPrice" id="projectPrice" value="${project.projectPrice }"></div>
                                                    </div>
                                                </div>
