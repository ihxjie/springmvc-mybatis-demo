                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive table mt-2" id="dataTable1" role="grid" aria-describedby="dataTable_info">
                            <table class="table dataTable my-0" id="dataTable">
                                <p><strong>报名id：</strong><span>${apply.applyId }</span></p>
                                <p><strong>项目id：</strong><span>${apply.projectId}</span></p>
                                <p><strong>报名账号：</strong><span>${apply.personId}</span></p>
                                <p><strong>报名人：</strong><span>${apply.personName}</span></p>
                                <p><strong>是否缴费：</strong><span><c:if test="${apply.status==0}">否</c:if><c:if test="${apply.status==1}">是</c:if></span></p>
                                <p><strong>报名类别：</strong><span><c:if test="${apply.isStudent==0}">学校</c:if><c:if test="${apply.isStudent==1}">公司</c:if></span></p>
                            </table>
                        </div>
                        <div class="row">
