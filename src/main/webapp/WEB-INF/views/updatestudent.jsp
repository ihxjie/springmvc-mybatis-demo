                        ...
                        <div class="row">
                            <div class="col">
                                <div class="card shadow mb-3">
                                    ...
                                    <div class="card-body">
                                        <form id="testsForm" name="testsForm" method="post" action="${pageContext.request.contextPath }/sys/studentList/modifysave.html">
                                            <input type = "hidden" id = "path" name = "path" value = "${pageContext.request.contextPath }">


                                            <div class="form-row">
                                                <div class="col">
                                                    <div class="form-group"><label for="studentId"><strong>账号</strong></label><input class="form-control" type="text" name="studentId" id="studentId" value="${student.studentId }"></div>
                                                </div>
                                                <div class="col">
                                                    <div class="form-group"><label for="studentPwd"><strong>密码</strong></label><input class="form-control" type="password" name="studentPwd" id="studentPwd" value="${student.studentPwd}"></div>
                                                </div>
                                            </div>
                                            <div class="form-row">
                                                <div class="col">
                                                    <div class="form-group"><label for="studentName"><strong>名字</strong></label><input class="form-control" type="text" name="studentName" id="studentName" value="${student.studentName }"></div>
                                                </div>
                                                <div class="col">
                                                    <div class="form-group"><label for="studentSex"><strong>性别</strong></label><input class="form-control" type="text" name="studentSex" id="studentSex" value="${student.studentSex }"></div>
                                                </div>
                                            </div>
                                            <div class="form-row">
                                                <div class="col">
                                                    <div class="form-group"><label for="studentMajor"><strong>专业</strong></label><input class="form-control" type="text" name="studentMajor" id="studentMajor" value="${student.studentMajor}"></div>
                                                </div>
                                                <div class="col">
                                                    <div class="form-group"><label for="studentClass"><strong>班级</strong></label><input class="form-control" type="text" name="studentClass" id="studentClass" value="${student.studentClass}"></div>
                                                </div>
                                            </div>
                                            <div class="form-row">
                                                <div class="col">
                                                    <div class="form-group"><label for="studentTel"><strong>联系电话</strong></label><input class="form-control" type="text" name="studentTel" id="studentTel" value="${student.studentTel }"></div>
                                                </div>
                                                <div class="col">
                                                    <div class="form-group"><label for="studentEmail"><strong>邮箱</strong></label><input class="form-control" type="text" name="studentEmail" id="studentEmail" value="${student.studentEmail }"></div>
                                                </div>
                                            </div>
