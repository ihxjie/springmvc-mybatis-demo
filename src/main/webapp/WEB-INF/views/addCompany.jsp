                        ...
                        <div class="row">
                            <div class="col">
                                <div class="card shadow mb-3">
                                    ...
                                    <div class="card-body">
                                        <form id="testsForm" name="testsForm" method="post" action="${pageContext.request.contextPath }/sys/companyList/addCompany.html">
                                            <input type = "hidden" id = "path" name = "path" value = "${pageContext.request.contextPath }">


                                            <div class="form-row">
                                                <div class="col">
                                                    <div class="form-group"><label for="companyId"><strong>公司id</strong></label><input class="form-control" type="text" name="companyId" id="companyId" value="${company.companyId }"></div>
                                                </div>
                                                <div class="col">
                                                    <div class="form-group"><label for="companyPwd"><strong>公司密码</strong></label><input class="form-control" type="password" name="companyPwd" id="companyPwd" value="${company.companyPwd}"></div>
                                                </div>
                                            </div>
                                            <div class="form-row">
                                                <div class="col">
                                                    <div class="form-group"><label for="companyName"><strong>公司名</strong></label><input class="form-control" type="text" name="companyName" id="companyName" value="${company.companyName}"></div>
                                                </div>
                                                <div class="col">
                                                    <div class="form-group"><label for="companyAddress"><strong>公司地址</strong></label><input class="form-control" type="text" name="companyAddress" id="companyAddress" value="${company.companyAddress }"></div>
                                                </div>
                                            </div>
                                            <div class="form-row">
                                                <div class="col">
                                                    <div class="form-group"><label for="contactName"><strong>联系人</strong></label><input class="form-control" type="text" name="contactName" id="contactName" value="${company.contactName}"></div>
                                                </div>
                                                <div class="col">
                                                    <div class="form-group"><label for="contactTel"><strong>联系人电话</strong></label><input class="form-control" type="text" name="contactTel" id="contactTel" value="${company.contactTel}"></div>
                                                </div>
                                            </div>
