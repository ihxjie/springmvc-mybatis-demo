...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath }/assets/js/projectadd.js"></script>
    ...
    <div class="d-flex flex-column" id="content-wrapper">
        <div id="content">
            ...
            <div class="container-fluid">
                <h3 class="text-dark mb-4">填写项目信息</h3>
                <div class="row mb-3">
                    <div class="col-lg-12">
                            ...
                            <div class="col">
                                <div class="card shadow mb-3">
                                    <div class="card-header py-3">
                                        <p class="text-primary m-0 font-weight-bold">内容设置</p>
                                    </div>
                                    <div class="card-body">
                                        <form id="projectForm" name="projectForm" method="post" action="${pageContext.request.contextPath }/sys/projectlist/addsave">
                                            <input type = "hidden" id = "path" name = "path" value = "${pageContext.request.contextPath }">
                                            <form>
                                                <div class="form-row">
                                                    <div class="form-group"><label for="申请方"><strong>申请方</strong></label><input class="form-control" type="text"  name="isCompany" id="isCompany" value="" }></div>
                                                </div>
                                                <div class="form-row">
                                                    <div class="form-group"><label for="负责方ID"><strong>负责方ID</strong></label><input class="form-control" type="text"  name="workId" id="workId" value="" }></div>
                                                </div>
                                                <div class="form-row">
                                                    <div class="form-group"><label for="实训标题"><strong>实训标题</strong></label><input class="form-control" type="text"  name="projectTitle" id="projectTitle" value="" }></div>
                                                </div>
                                                <div class="form-row">
                                                    <div class="form-group"><label for="实训周期"><strong>实训周期</strong></label><input class="form-control" type="text"  name="period" id="period" value="" }></div>
                                                </div>
                                                <div class="form-row">
                                                    <div class="form-group"><label for="实训内容"><strong>实训内容</strong></label><input class="form-control" type="text"  name="projectContent" id="projectContent" value="" }></div>
                                                </div>
                                                <div class="form-row">
                                                    <div class="form-group"><label for="实训基地"><strong>实训基地</strong></label><input class="form-control" type="text"  name="projectAddress" id="projectAddress" value="" }></div>
                                                </div>
                                                <div class="form-row">
                                                    <div class="form-group"><label for="实训价格"><strong>实训价格</strong></label><input class="form-control" type="text"  name="projectPrice" id="projectPrice" value="" }></div>
                                                </div>

                                                <div class="form-group">
                                                    <input class="btn btn-primary btn-sm" type="submit" value="申报">
