...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath }/assets/js/resultstudent.js"></script>
</head>
                ...
                <table class="providerTable" cellpadding="0" cellspacing="0">
                    ...
                    <c:forEach var="apply" items="${applyList}" varStatus="status">
                        <tr>
                            ...
                            <td>
                                <span><a class="addResult" href="javascript:;" personId=${apply.personId } personName=${apply.personName }>打分</a></span>
                            </td>
                        </tr>
                    </c:forEach>
                </table>
