                            ...
                            <div class="nav-item dropdown no-arrow">
                                <a class="dropdown-toggle nav-link" data-toggle="dropdown" aria-expanded="false" href="#">
                                    <span class="d-none d-lg-inline mr-2 text-gray-600 small">
                                                <p><span style="color: #fff21b"> ${teacherSession.name }</span>欢迎你！</p>
                                    </span>
                                    <img class="border rounded-circle img-profile" src="${pageContext.request.contextPath }/assets/img/avatars/avatar1.jpeg">
                                </a>
                                <div
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="card shadow mb-3">
                                    ...
                                    <div class="card-body">
                                        <form id="testsForm" name="testsForm" method="post" action="${pageContext.request.contextPath }/sys/adminList/modifysave.html">
                                            <input type = "hidden" id = "path" name = "path" value = "${pageContext.request.contextPath }">

                                            <div class="form-row">
                                                <div class="col">
                                                    <div class="form-group"><%--@declare id="adminid"--%><label for="adminId"><strong>账号</strong></label><input class="form-control" type="text" name="adminId" id="adminId" value="${admin.adminId }"></div>
                                                </div>
                                                <div class="col">
                                                    <div class="form-group"><%--@declare id="adminpwd"--%><label for="adminPwd"><strong>密码</strong></label><input class="form-control" type="password" name="adminPwd" id="adminPwd" value="${admin.adminPwd }"></div>
                                                </div>
                                            </div>
