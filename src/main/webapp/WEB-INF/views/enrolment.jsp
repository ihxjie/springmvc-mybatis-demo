                        ...
                        <div class="card shadow border-left-info py-2">
                            <div class="card-body">
                                <div class="row align-items-center no-gutters">
                                    ...
                                    <div onclick="window.open('${pageContext.request.contextPath}/enrolment','_self')" class="col-auto"><i class="fas fa-clipboard-list fa-2x text-info"></i></div>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script src="assets/js/enrolment-js.js"></script>
