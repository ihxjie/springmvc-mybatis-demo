                ...
                <div class="container-fluid"><button class="btn btn-link d-md-none rounded-circle mr-3" id="sidebarToggleTop" type="button"><i class="fas fa-bars"></i></button>
                    ...
                    <ul class="nav navbar-nav flex-nowrap ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow" role="presentation">
                            <div class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link" data-toggle="dropdown" aria-expanded="false" href="#"><span class="d-none d-lg-inline mr-2 text-gray-600 small">Valerie Luna</span><img class="border rounded-circle img-profile" src="${pageContext.request.contextPath }/assets/img/avatars/avatar1.jpeg"></a>
                                <div
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive table mt-2" id="dataTable1" role="grid" aria-describedby="dataTable_info">
                            <table class="table dataTable my-0" id="dataTable">
                                <p><strong>公司id：</strong><span>${company.companyId }</span></p>
                                <p><strong>公司名字：</strong><span>${company.companyName}</span></p>
                                <p><strong>公司地址：</strong><span>${company.companyAddress }</span></p>
                                <p><strong>联系人：</strong><span>${company.contactName}</span></p>
                                <p><strong>联系人电话：</strong><span>${company.contactTel }</span></p>
                            </table>
                        </div>
                        <div class="row">
