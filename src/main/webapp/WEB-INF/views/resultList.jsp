...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath }/assets/js/resultList.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath }/assets/js/admin.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath }/assets/js/deleteResults.js"></script>

    <script type="text/javascript">
        function d(){
            window.location.href="${pageContext.request.contextPath}/sys/resultController/excel";
        }
    </script>
            ...
            <nav class="navbar navbar-light navbar-expand bg-white shadow mb-4 topbar static-top">
                <div class="container-fluid"><button class="btn btn-link d-md-none rounded-circle mr-3" id="sidebarToggleTop" type="button"><i class="fas fa-bars"></i></button>
                    <div class="input-group">
                        <form method="post" action="${pageContext.request.contextPath }/sys/resultList/looklist.html">
                            <span>账号：</span>
                            <input name="resultId" id="resultId" class="input-text"	type="text" value="${resultId}">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 text-nowrap">
                                <button><a name="delAllResult" id = "delAllResult" href="#" >批量删除</a></button>
                            </div>
                            <div>
                                ...
                                <c:forEach var="tests" items="${pageInfo.list}" >
                                    <tr>
                                        <td>
                                            ...
                                            <span class = "id">${tests.resultId}</span>
                                        </td>
                                        <td>
                                            <span>${tests.studentId}</span>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <span><a class="viewResult" href="javascript:;" studentId=${tests.studentId} studentName=${tests.studentName }><img src="${pageContext.request.contextPath }/assets/img/read.png" alt="查看" title="查看"/></a></span>

                                            <span><a class="modifyResult"  href="javascript:;" studentId=${tests.studentId } studentName=${tests.studentName}><img src="${pageContext.request.contextPath }/assets/img/xiugai.png" alt="修改" title="修改"/></a></span>
                                        </td>
                                    </tr>
                                </c:forEach>
                            </table>
