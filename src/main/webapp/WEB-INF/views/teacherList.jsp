...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath }/assets/js/teacherList.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath }/assets/js/admin.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath }/assets/js/deleteTeachers.js"></script>
    <script type="text/javascript">
        function d(){
            window.location.href="${pageContext.request.contextPath}/sys/teacherController/excel";
        }
    </script>
            ...
            <nav class="navbar navbar-light navbar-expand bg-white shadow mb-4 topbar static-top">
                <div class="container-fluid"><button class="btn btn-link d-md-none rounded-circle mr-3" id="sidebarToggleTop" type="button"><i class="fas fa-bars"></i></button>
                    <div class="input-group">
                        <form method="post" action="${pageContext.request.contextPath }/sys/teacherList/looklist.html">
                            <span>教师账号：</span>
                            <input name="teacherId" id="teacherId" class="input-text"	type="text" value="${teacherId}">
            ...
            <div class="container-fluid">
                ...
                <div class="card shadow">
                    <div class="card-header py-3">
                        <a href="${pageContext.request.contextPath}/sys/teacherList/add.html" >添加教师</a>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 text-nowrap">
                                <button><a name="delAllTeacher" id = "delAllTeacher" href="#" >批量删除</a></button>
                            </div>
                            <div>
                                ...
                                <c:forEach var="tests" items="${pageInfo.list}" varStatus="status">
                                    <tr>
                                        <td>
                                            ...
                                            <span class = "id">${tests.teacherId}</span>
                                        </td>
                                        <td>
                                            <span>${tests.teacherName}</span>
                                        </td>
                                        <td>
                                            <span>${tests.teacherSex}</span>
                                        </td>
                                        <td>
                                            <span>${tests.teacherTel}</span>
                                        </td>
                                        <td>
                                            <span>${tests.introduction}</span>
                                        </td>
                                        <td>

                                            <span>${tests.teacherEmail}</span>
                                        </td>
                                        <td>
                                            <span><a class="viewTeacher" href="javascript:;" teacherId=${tests.teacherId} teacherName=${tests.teacherName }><img src="${pageContext.request.contextPath }/assets/img/read.png" alt="查看" title="查看"/></a></span>

                                            <span><a class="modifyTeacher"  href="javascript:;" teacherId=${tests.teacherId } teacherName=${tests.teacherName}><img src="${pageContext.request.contextPath }/assets/img/xiugai.png" alt="修改" title="修改"/></a></span>
                                            <span><a class="deleteTeacher" href="javascript:;" teacherId=${tests.teacherId } teacherName=${tests.teacherName }><img src="${pageContext.request.contextPath }/assets/img/schu.png" alt="删除" title="删除"/></a></span>
                                        </td>
                                    </tr>
                                </c:forEach>
                            </table>
                            ...
                            <div class="col-md-6 offset-md-4">
                                <nav aria-label="Page navigation example">
                                    <ul class="pagination pagination-sm">
                                        <li class="page-item"><a class="page-link" href="${BASE_PATH}/springmvc_mybatis_demo_war/teacherList?page=1">首页</a></li>
                                        <c:if test="${pageInfo.hasPreviousPage}">
                                            <li class="page-item"><a class="page-link"
                                                                     href="${BASE_PATH}/springmvc_mybatis_demo_war/teacherList?page=${pageInfo.pageNum-1}">上一页</a></li>
                                        </c:if>
                                        <c:forEach items="${pageInfo.navigatepageNums}" var="page">
                                            ...
                                            <c:if test="${page!=pageInfo.pageNum}">
                                                <li class="page-item"><a class="page-link"
                                                                         href="${BASE_PATH}/springmvc_mybatis_demo_war/teacherList?page=${page}">${page}</a></li>
                                            </c:if>
                                        </c:forEach>
                                        <c:if test="${pageInfo.hasNextPage}">
                                            <li class="page-item"><a class="page-link"
                                                                     href="${BASE_PATH}/springmvc_mybatis_demo_war/teacherList?page=${pageInfo.pageNum+1}">下一页</a></li>
                                        </c:if>
                                        <li class="page-item"><a class="page-link" href="${BASE_PATH}/springmvc_mybatis_demo_war/teacherList?page=${pageInfo.pages}">末页</a>
                                        </li>
                                    </ul>
                                </nav>
                            </div>
