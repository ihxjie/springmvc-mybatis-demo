                        ...
                        <div class="col-lg-6">
                            <div class="p-5">
                                ...
                                <form class="user" id="login_form" method="post">
                                    ...
                                    <div class="form-group">
                                        <input class="form-control form-control-user" type="password" id="password" placeholder="请输入您的密码" name="password"></div>
                                    <hr><a class="btn btn-primary btn-block text-white btn-google btn-user" role="button" ><i class="fab fa-user-f"></i>&nbsp; 学生登录</a>
                                ...
                                <div class="text-center"><a class="small" href="register.html">立即创建新账户!</a>atu</div>
                            </div>
                        </div>
                    </div>
                </div>
...
<script src="${pageContext.request.contextPath }/assets/js/login-js.js"></script>
</body>
